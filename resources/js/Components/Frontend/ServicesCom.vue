...
import ServiceContainerCom from "@/Components/Frontend/ServiceContainerCom.vue";
</script>
    ...
    <section id="services" class="section bg-light-secondary dark:bg-dark-secondary">
        <div v-motion :initial="{opacity: 0,y: 100,}" :visible="{opacity: 1,y: 0,}"
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam, quisquam.</p>
            </div>
            <div class="grid lg:grid-cols-4 gap-8">
                <ServiceContainerCom>
                    ...
                    <template #title>Web Design</template>
                    <template #description>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A, alias animi
                        laboriosam natus quibusdam voluptate?
                    </template>
                </ServiceContainerCom>
                <ServiceContainerCom>
                    <template #icon>
                ...
                <ServiceContainerCom>
                    <template #icon>
                        <svg class="h-24 h-24" fill="none" stroke="currentColor" stroke-width="1.5"
